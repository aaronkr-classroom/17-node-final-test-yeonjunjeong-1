...
router.get("/", discussionsController.index, discussionsController.indexView); 
// 2. 생성 폼을 보기 위한 요청 처리        = GET /discussions/new,            new 액션
router.get("/new", discussionsController.new);
...
router.get("/:id", discussionsController.show, discussionsController.showView);
// 5. edit를 처리하기 위한 라우트          = GET /discussions/:id/edit,       edit 액션
router.get("/:id/edit", discussionsController.edit);
